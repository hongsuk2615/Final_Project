            ...
            <div id="login-form">
                <form action="/thrifty/member/login" method="post">
                    <div>
                        ...
                        <input style="cursor : pointer;" type="text" name="userId">
                    </div>
                    <div>
                        <img src="/thrifty/resources/images/login/unlock.png" alt="비밀번호 이미지" width="40" height="40">
                        <input style="cursor : pointer;" type="password" name="userPwd">
                    </div>
                    <button style="cursor : pointer;">  로그인</button>
                </form>
            </div>
            <div id="login-others-btns">
                <div style="cursor : pointer;"  onclick="enroll();">회원가입</div>
                <div style="cursor : pointer;"  onclick="findId();">아이디/비밀번호 찾기</div>
            </div>
            <div id="sns-login">
                <fieldset>
                    <legend style="width: initial; height : 10px; margin: initial;font-size: initial;line-height: initial;white-space: initial;">SNS로그인</legend>    
                </fieldset>
...
function findId(){
        ...
        <div id="find-form">
            <form action="" method="post">
                <div>
                    <div>
                        <div>이름</div>
                        <input style="cursor : pointer;"  type="text" name="userName" id="findIdName">
                    </div>
                    <div>
                        <div>이메일</div>
                        <input style="cursor : pointer;"  type="email" name="email" id="findIdEmail">
                    </div>
                    <div id="btns">
                        <button style="cursor : pointer;"  type="button" id="findId-btn" onclick="findIdAjax();">확인</button>
                        <button style="cursor : pointer;"  type="button" id="findPwd-btn" onclick="findPwd();">비밀번호 찾기</button>
                    </div>
                </div>
    ...
    <button style="cursor : pointer;"  id="loginMenu-btn" onclick="login();">로그인 창으로</button>
</div> `,
        showConfirmButton: false
    });
}
        ...
        <div id="find-form">
            <form action="" method="post">
                <div>
                    <div>
                        <div>아이디</div>
                        <input style="cursor : pointer;"  type="text" name="userId" id="findPwdId">
                    </div>
                    <div>
                        <div>이메일</div>
                        <input style="cursor : pointer;"  type="email" name="email" id="findPwdEmail">
                    </div>
                    <div id="btns">
                        <button style="cursor : pointer;"  type="button" id="findPwd-btn" onclick="findPwdAjax();">확인</button>
                    </div>
                </div>
...
function enroll(){
    Swal.fire({
        ...
        <div id="enroll-form">
            <form action="" class="scrollbar2" method="post">
                <table >
                    <tr>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;"  type="text" id="userId" name="userId" onkeyup="regCheckId();">
                        </td>
                        <td>
                            <button style="cursor : pointer;"  type="button" onclick="validateId('on');">중복확인</button>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;"  type="password" id="userPwd" name="userPwd" onkeyup="regCheckPwd();">
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;"  type="password" id="checkPwd" onkeyup="checkPassword();">
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th style="cursor : pointer;"  class="title" colspan="2">이메일</th>
                    </tr>
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;" type="email" id="email" name="email" onkeyup="regCheckEmail();">
                        </td>
                        <td>
                            <button style="cursor : pointer;" type="button" onclick="validateEmail('on')">중복확인</button>
                        </td>
                    </tr>
                    <tr>
                        <td class="validate" colspan="2"></td>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;" type="text" id="nickName" name="nickName" onkeyup="regCheckNickName();">
                        </td>
                        <td>
                            <button style="cursor : pointer;" type="button" onclick="validateNickName('on')" >중복확인</button>
                        </td>
                    </tr>
                    <tr>
                        <td class="validate" colspan="2"></td>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;" type="text" name="userName" id="userName" onkeyup="regCheckName();">
                        </td>
                        <td></td>
                    </tr>      
                    <tr>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;" type="text" id="phone" name="phone" onkeyup="regCheckPhone();">
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="input">
                            <input style="cursor : pointer;" type="radio" name="gender" id="gender-m" value="M" checked>
                            <label style="cursor : pointer;"  for="gender-m">남</label>
                            <input style="cursor : pointer;" type="radio" name="gender" id="gender-f" value="F">
                            <label style="cursor : pointer;" for="gender-f">여</label>
                        </td>
                        <td></td>
                    </tr>
                    <tr>
                ...
                <div id="enroll-term" style="white-space: pre-line;  height: 300px;" ><div class="scrollbar2	" style="overflow-y:scroll; height : 100%;">
...
제24조(재판권 및 준거법)
  ...
  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</div></div>
                <div class="justify-end">
                    <input style="cursor : pointer;" type="checkbox" id="term-checkbox">

                    <label style="cursor : pointer;" for="term-checkbox">약관에 동의합니다</label>
                </div>
                <div class="justify-center" >
                    <button style="cursor : pointer;" type="button"  id ="cancel-btn" onclick="login();">취소</button>
                    <button style="cursor : pointer;" type="button" onclick="validateEnroll();" id="enroll-btn">회원가입</button>
                </div>
            </form>
        </div>
   </div>`,
...
function findPwdAjax(){
    ...
    $.ajax({
        ...
        success : function(result){
            if(result ==''){
                customAlert("잘못된 이메일이거나 아이디입니다.");
            }else{
                Swal.fire({
                    position: 'top-center',
                    icon: 'success',
                    title: email+'로 임시비밀번호를 전송했습니다.',
                    showConfirmButton: false,
                    timer: 1500
                }).then(()=>{
                        login();
